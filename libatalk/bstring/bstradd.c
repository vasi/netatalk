 ...
 *
 * This is usefull if a well know code path uses string, often doing strlen on
 * string. By converting to bstring which carries the strlen, the repeated
...
/*!
 * @brief Create an empty list with preallocated storage for at least 'min'
 * members
 */
 ...
 */
bstring bstrListPop(struct bstrList *sl) { return NULL; }
