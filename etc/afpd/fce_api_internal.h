...
#define FCE_MAX_UDP_SOCKS                                                      \
  5 /* Allow a maximum of udp listeners for file change events */
#define FCE_SOCKET_RETRY_DELAY_S                                               \
  600                      /* Pause this time in s after socket was broken */
#define FCE_HISTORY_LEN 10 /* This is used to coalesce events */
#define MAX_COALESCE_TIME_MS                                                   \
  1000 /* Events oldeer than this are not coalesced */
