...
extern int add_cnid(DBD *dbd, struct cnid_dbd_rqst *rqst,
...
extern int dbd_resolve(DBD *dbd, struct cnid_dbd_rqst *,
...
extern int dbd_delete(DBD *dbd, struct cnid_dbd_rqst *, struct cnid_dbd_rply *,
                      int idx);
extern int dbd_getstamp(DBD *dbd, struct cnid_dbd_rqst *,
                        struct cnid_dbd_rply *);
extern int dbd_rebuild_add(DBD *dbd, struct cnid_dbd_rqst *,
                           struct cnid_dbd_rply *);
