...
static const char *labels[] = {"none",   "grey", "green",  "violet", "blue",
                               "yellow", "red",  "orange", NULL};
...
static void usage_set(void) {
  printf(
      "Usage: ad set [-t TYPE] [-c CREATOR] [-l label] [-f flags] [-a "
      "attributes] file|dir \n\n"
      "     Color Label:\n"
...
static void change_type(char *path, afpvol_t *vol, const struct stat *st,
                        struct adouble *ad, char *new_type) {
  char *FinderInfo;
...
static void change_creator(char *path, afpvol_t *vol, const struct stat *st,
                           struct adouble *ad, char *new_creator) {
  char *FinderInfo;
...
static void change_label(char *path, afpvol_t *vol, const struct stat *st,
                         struct adouble *ad, char *new_label) {
  char *FinderInfo;
...
static void change_attributes(char *path, afpvol_t *vol, const struct stat *st,
                              struct adouble *ad, char *new_attributes) {
...
static void change_flags(char *path, afpvol_t *vol, const struct stat *st,
                         struct adouble *ad, char *new_flags) {
  char *FinderInfo;
  uint16_t FinderFlags;
