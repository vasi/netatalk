...
static char *netatalk_dirs[] = {ADv2_DIRNAME, ".AppleDB", ".AppleDesktop",
                                NULL};

static char *labels[] = {"---", "gry", "gre", "vio",
                         "blu", "yel", "red", "ora"};
...
static void usage_ls(void) {
  printf(
      ...
      "     <unixinfo ...> <FinderFlags> <AFPAttributes> <Color> <Type> "
      "<Creator> <CNID from AppleDouble> <name>\n\n"
