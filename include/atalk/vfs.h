...
#define VFS_FUNC_ARGS_CHOWN                                                    \
  const struct vol *vol, const char *path, uid_t uid, gid_t gid
#define VFS_FUNC_VARS_CHOWN vol, path, uid, gid

#define VFS_FUNC_ARGS_RENAMEDIR                                                \
  const struct vol *vol, int dirfd, const char *oldpath, const char *newpath
...
#define VFS_FUNC_ARGS_SETFILEMODE                                              \
  const struct vol *vol, const char *name, mode_t mode, struct stat *st
...
#define VFS_FUNC_ARGS_SETDIROWNER                                              \
  const struct vol *vol, const char *name, uid_t uid, gid_t gid
#define VFS_FUNC_VARS_SETDIROWNER vol, name, uid, gid

#define VFS_FUNC_ARGS_DELETEFILE                                               \
  const struct vol *vol, int dirfd, const char *file
#define VFS_FUNC_VARS_DELETEFILE vol, dirfd, file

#define VFS_FUNC_ARGS_RENAMEFILE                                               \
  const struct vol *vol, int dirfd, const char *src, const char *dst
...
#define VFS_FUNC_ARGS_ACL                                                      \
  const struct vol *vol, const char *path, acl_type_t type, int count, acl_t acl
#define VFS_FUNC_VARS_ACL vol, path, type, count, acl
#endif

#define VFS_FUNC_ARGS_REMOVE_ACL                                               \
  const struct vol *vol, const char *path, int dir
#define VFS_FUNC_VARS_REMOVE_ACL vol, path, dir

#define VFS_FUNC_ARGS_EA_GETSIZE                                               \
  const struct vol *restrict vol, char *restrict rbuf,                         \
...
#define VFS_FUNC_VARS_EA_GETCONTENT                                            \
  vol, rbuf, rbuflen, uname, oflag, attruname, maxreply, fd

#define VFS_FUNC_ARGS_EA_LIST                                                  \
  const struct vol *restrict vol, char *restrict attrnamebuf,                  \
...
#define VFS_FUNC_ARGS_EA_SET                                                   \
  const struct vol *restrict vol, const char *restrict uname,                  \
